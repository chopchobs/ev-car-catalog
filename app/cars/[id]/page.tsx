...
export default async function CarDetailPage({
  ...
  const getStatusBadge = (status: "AVAILABLE" | "BOOKED" | "SOLD") => {
    switch (status) {
      ...
      case "BOOKED":
        return (
          <span className="bg-orange-100 text-orange-800 px-4 py-1.5 rounded-full text-sm font-bold tracking-wide">
            จองแล้ว
          </span>
        );
      case "SOLD":
        return (
          <span className="bg-gray-100 text-gray-800 px-4 py-1.5 rounded-full text-sm font-bold tracking-wide">
            ขายแล้ว (Sold Out)
          </span>
        );
    }
    ...
    <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-950">
      ...
      <main className="grow pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-4xl shadow-sm border border-gray-100 dark:border-slate-800 p-6 sm:p-8 lg:p-10 mb-8">
              ...
              <div className="flex flex-col">
                ...
                <div className="flex items-center gap-4 mb-6 relative">
                  ...
                  <div className="relative w-12 h-12 shrink-0">
                    <FavoriteButton
                      carId={car.id}
                      initialIsFavorite={savedCarIds.includes(car.id)}
                    />
                  </div>
                </div>
                  ...
                  <div className="mb-8">
                    ...
                    <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      {car.features.map((feat, idx) => (
                        <li
                          key={idx}
                          className="flex items-center gap-3 text-gray-600 dark:text-slate-300 bg-gray-50 dark:bg-slate-800/50 px-4 py-2 rounded-xl"
                        >
                          <svg
                ...
                <div className="mt-auto pt-6">
                  ...
                  <p className="text-center sm:text-left text-sm text-gray-400 dark:text-slate-500 mt-4">
                    ติดต่อสอบถามหรือนัดหมายได้ตลอด 24 ชั่วโมง แอดมินตอบกลับภายใน
                    30 นาที 😊
                  </p>
                </div>
              </div>
