      ...
      <div className="pt-32 pb-16 bg-white border-b border-neutral-200">
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <p className="text-lg text-neutral-500 max-w-2xl font-light">
            มีคำถามเกี่ยวกับแคตตาล็อกรถยนต์ไฟฟ้าของเราหรือไม่?
            ไม่ว่าคุณจะสนใจรถยนต์รุ่นใด ต้องการความช่วยเหลือ
            หรือเพียงต้องการทักทาย เราพร้อมช่วยเหลือคุณ
          </p>
        </div>
      </div>

      {/* Content Section */}
      <main className="grow container mx-auto px-6 max-w-5xl py-16">
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  <div className="shrink-0 mt-1 bg-neutral-100 p-3 rounded-full">
                    <svg
