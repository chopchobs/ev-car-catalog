...
export default function ProfileDropdown({ user }: { user: UserProfile }) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        <div className="w-10 h-10 rounded-full bg-linear-to-br from-cyan-500 to-blue-600 flex items-center justify-center text-white font-bold shadow-md shadow-cyan-500/20">
