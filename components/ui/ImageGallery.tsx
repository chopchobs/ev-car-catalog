        ...
        <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide py-1 px-1">
          {images.map((url, idx) => (
            <button
              ...
              className={`relative shrink-0 w-20 h-20 sm:w-24 sm:h-24 rounded-2xl overflow-hidden shadow-sm transition-all focus:outline-none ${
                currentIndex === idx
                  ? "ring-4 ring-cyan-500 ring-offset-2 scale-100 opacity-100"
