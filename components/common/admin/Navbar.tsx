      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3 cursor-pointer group">
          <div className="text-right hidden sm:block">
            <p className="text-sm font-bold text-gray-800 group-hover:text-cyan-600 transition-colors">
              {user?.name || "Admin"}
            </p>
          ...
          {/* รูปโปรไฟล์ */}
          <div className="w-10 h-10 rounded-full bg-linear-to-br from-cyan-500 to-blue-600 border border-cyan-200 text-white flex items-center justify-center font-bold shadow-md shadow-cyan-500/20">
