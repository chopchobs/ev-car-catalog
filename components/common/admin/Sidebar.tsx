  ...
  return (
    <aside className="w-64 bg-[#0b1120] text-white flex flex-col min-h-screen">
      <div className="p-6 border-b border-gray-800">
        <h2 className="text-2xl font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">EVo Admin</h2>
        {user && <p className="text-sm text-gray-400 mt-1.5 truncate font-medium">✨ {user.name}</p>}
      </div>
      ...
      <div className="p-4 space-y-2 border-t border-gray-800 bg-[#070b16]">
        ...
        <form action={logoutUser}>
          ...
          >
            <svg className="w-5 h-5 text-red-600/70 group-hover:text-red-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" /></svg>
            ออกจากระบบ
          </button>
        </form>
      </div>
